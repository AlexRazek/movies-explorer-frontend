    ...
    <section className="portfolio">
        ...
        <ul className="portfolio__items">
            <li className="portfolio__item">
                <a 
                href="https://github.com/AlexRazek/how-to-learn" className="portfolio__link portfolio__link_border-bottom" target="_blank" rel="noreferrer">
            ...
            <li className="portfolio__item">
                <a 
                href="https://github.com/AlexRazek/russian-travel" className="portfolio__link portfolio__link_border-bottom" target="_blank" rel="noreferrer">
