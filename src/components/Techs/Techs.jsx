...
const Techs = (props) => {
  return (
    <section className="techs">
      <h2 className="techs__about techs__about_margin-top">Технологии</h2>
      <div className="techs__description">
        <h3 className="techs__description-text">7 технологий</h3>
        <p className="techs__description-subtext">
